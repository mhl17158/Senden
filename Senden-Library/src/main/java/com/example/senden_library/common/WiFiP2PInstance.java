...
import com.example.senden_library.Client.SendenClient;
...
public class WiFiP2PInstance implements WifiP2pManager.ConnectionInfoListener {
    ...
    private SendenDevice thisDevice;
    ...
    public void setThisDevice(SendenDevice thisDevice) {
        this.thisDevice = thisDevice;
    }

    public SendenDevice getThisDevice() {
        return thisDevice;
    }

    public void setPeerConnectedListener(SendenService peerConnectedListener) {
        this.peerConnectedListener = peerConnectedListener;
    }

    public void setServerDisconnectedListener(SendenClient serviceDisconnectedListener) {
