...
public class SendenDevice {
    ...
    public SendenDevice(WifiP2pDevice device) {
    ...
    public String toString() {
        return new StringBuilder().append("SendenDevice[deviceName=").append(deviceName).append("][deviceMac=").append(deviceMac).append("][deviceServerSocketIP=").append(deviceServerSocketIP).append("][deviceServerSocketPort=").append(deviceServerSocketPort).append("]").toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        SendenDevice that = (SendenDevice) o;
